	...
	class Mycalendar_model extends CI_Model
	{
		...
		public function __construct()
		{
			...
			$this->prefs['template'] =   '
				...
				<div class="day_number highlight"></div>
				<div class="day_content"></div>
   				{/cal_cell_content_today}

   				{cal_cell_no_content}<div class="day_number">{day}</div>{/cal_cell_no_content}
   				{cal_cell_no_content_today}<div class="day_number highlight">{day}</div>{/cal_cell_no_content_today}
		...
		public function new_calendar_data($date, $data)
		{
